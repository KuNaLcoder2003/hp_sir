            ...
            <div className="px-4 mx-auto sm:px-6 md:px-0">
                <div className="pt-32 pb-12 md:pt-40 md:pb-20">
                    <div className="pb-12 text-center md:pb-16">
                        <h1
                            className="mb-6 border-y border-none text-5xl max-w-3xl mx-auto font-normal tracking-tighter [border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.),transparent)1] md:text-6xl"
                            data-aos="zoom-y-out"
                            data-aos-delay={150}
                        >
                        ...
                        <div className="relative mx-auto max-w-3xl">
                            <p
                                className="mb-8 text-lg text-white-700 font-semibild"
                                data-aos="zoom-y-out"
                                data-aos-delay={300}
                            >
